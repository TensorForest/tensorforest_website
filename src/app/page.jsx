...
export function Home() {
    return (
        <div className="space-y-32">
            {/* Hero Section */}
            <section className="relative overflow-hidden rounded-[2rem] mx-4">
                <Image
                    src="/hero.png"
            ...
            {/* CTA Section */}
            <section className="relative overflow-hidden rounded-[2rem] mx-4 bg-gradient-to-br from-red-900/80 to-black p-12 min-h-[600px] flex flex-col justify-between">
